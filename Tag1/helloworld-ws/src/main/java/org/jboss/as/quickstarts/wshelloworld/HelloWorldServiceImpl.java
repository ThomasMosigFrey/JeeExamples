 ...
 */
@WebService(serviceName = "HelloWorldService2", portName = "HelloWorld2", name = "HelloWorld2", endpointInterface = "org.jboss.as.quickstarts.wshelloworld.HelloWorldService",
